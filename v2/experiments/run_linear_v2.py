...
def main():
    ...
    # --------------------------
    # x_true = generate_linear_signal(T=9000, a=0.5, b=2.0)
    generator = LinearSSMGenerator()
    x_true, _  = generator.generate()
    ...
    plt.legend()
    plt.title("Linear Signal Denoising")
    plt.xlabel("Time")
    plt.ylabel("Value")
    plt.grid(True)

    # plt.show()
    plt.savefig('knet_after_training_on_linear_model.png')
